                        ...
                        <tbody>
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td style="width: 30ch"><h5>{{$order->status}}</h5></td>  
                                    <td style="width: 10ch"><h5><a href="/deletesend_user/{{$order->id_order}}/{{$order->id_product}}" class="btn btn-danger">ลบ</a></h5></td>   
                                </tr>    
                            @endforeach
                        </tbody>
                    </table>
